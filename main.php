...
<html lang="en">
 ...
 <body> 
  <nav id="navbar"> 
   <div id="logo"> 
    <!-- <img src="l.svg" alt="makemytrip.com">  -->
    <svg version="1.1" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" width="30%" height="30%" viewBox="0 0 500 500"><rect width="100%" height="100%" fill="#C50E52" fill-opacity="1"/><svg viewBox="1072.1823 789.7096 356.9979 123.3447" width="333" height="115.05329611182586" x="83.5px" y="192.4734px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="none"><defs></defs><style>.companyName {fill:#FFF9F2;fill-opacity:1;}.icon3-str {stroke:#73022C;stroke-opacity:1;}.shapeStroke-str {stroke:#73022C;stroke-opacity:1;}.text {fill:#FFF9F2;fill-opacity:1;}</style><g opacity="1" transform="rotate(0 1072.1823 869.7096)">
      <svg width="356.9979" height="23.3447" x="1072.1823" y="869.7096" version="1.1" preserveAspectRatio="none" viewBox="4.2 -28 428.20000000000005 28">
      ...
      </g><g opacity="1" transform="rotate(0 1072.1823 789.7096)">
      <svg width="356.9979" height="60" x="1072.1823" y="789.7096" version="1.1" preserveAspectRatio="none" viewBox="0.16 -28 166.6 28">
      ...
      </g><g opacity="1" transform="rotate(0 1072.1823 907.0543)">
      <svg width="356.9979" height="6" x="1072.1823" y="907.0543" version="1.1" preserveAspectRatio="none" viewBox="0 0 356.9979 6">
        <defs><rect x="0" y="0" width="356.9979" height="6" rx="0px" ry="0px" id="id-MGa_3CcrI1705241636327"></rect></defs><use class="companyName shapeStroke-str" style="stroke-width:0;" xlink:href="#id-MGa_3CcrI1705241636327"></use>
      </svg>
      </g></svg></svg></svg>
    </div> 
   <ul> 
...
<label for="search"> </label> 
  ...
  <section id="home"> 
   <h1 class="h-primary">Welcome to Make My Trip</h1> 
   <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Perferendis dolorum numquam minus. </p> 
   <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. </p> 
   <button class="btn"><a href="check_now/index.html">Check Now</a></button> 
  </section> 
  <section id="services-container"> 
   <h1 class="h-primary center">Our Services</h1> 
   <div id="services"> 
    <div class="box"> 
     <img src="expence.png" alt="" height="500px" width="300px"> 
     <h2 class="h-secondary center"><a href="expence.html">Expence Tracker</a></h2> 
    ...
    <div class="box"> 
     <img src="translator.jpg" alt=""  height="500px" width="300px"> 
     <h2 class="h-secondary center"><a href="translator.html">Language Translator</a></h2> 
    ...
    <div class="box"> 
     <img src="cu.jpg" alt=""  height="500px" width="300px" > 
     <h2 class="h-secondary center" > <a href="currency.html">Currency Convertor</a></h2> 
    
     <p class="center">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quidem, culpa suscipit error Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus provident fugiat aliquam minima at explicabo. Earum eveniet quaerat, sunt molestias nesciunt quas! Quis. sint delectus ab dolorum nam. Debitis facere, incidunt voluptates eos, mollitia voluptatem iste sunt voluptas beatae facilis labore, omnis sint quae eum.</p> 
    </div> 
   </div> 
  </section> 
  <section id="client-section"> 
   ...
   <!--<div id="clients"> 
    ...
    <marquee  direction="left"><img src="company.png" alt="Our Client"> </marquee>
   </div> 
  </section> 
        ...
        <div class="owl-carousel client_owl-carousel">
          <div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="review4.png" alt="" class="box-img">
              </div>
            </div>
          </div>
          <div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="review2.jpg" alt="" class="box-img">
              </div>
            </div>
          </div>
        </div>
  ...
  <footer>
    ...
    <div class="container">
        <div class="footer-content">
            <h3>Contact Us</h3>
            <p>Email:hrushalipatil2002@.com</p>
        ...
        <div class="footer-content">
            <h3>Quick Links</h3>
             <ul class="list">
                ...
                <li><a href="#client-section">Review</a></li>
        ...
        <div class="footer-content">
            ...
            <ul class="social-icons">
             ...
             <li><a href="#https://www.instagram.com/hrushali_30/"><i class="fab fa-instagram"></i></a></li>
             <li><a href="#https://www.linkedin.com/login"><i class="fab fa-linkedin"></i></a></li>
            </ul>
            </div>
    </div>
    <div class="bottom-bar">
        <p>Copyright © www.makemytrip.com. All rights reserved!</p>
    </div>
  </div>
</footer>
